...
def predict(image):
    ...
    _, processed_image = preprocess_image(image) # Resizing the image
    ...
    if image:
        ...
        if st.button("Start Prediction"):
            ...
            with col2:
                ...
                st.image(resized_image, caption='Resized Image for Prediction (299x299)', use_container_width=True)
