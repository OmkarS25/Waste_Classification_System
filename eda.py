    ...
    if visualization_option == "Dataset Information and Distribution":
        ...
        for i in range(1, 4):
            with cols[i-1]:
                ...
                st.image(img_path, caption=f'{selected_category.capitalize()} ({i})', use_container_width=True)
                ...
                if category != selected_category:
                    ...
                    for i in range(1, 4):
                        with cols[i-1]:
                            ...
                            st.image(img_path, caption=f'{category.capitalize()} ({i})', use_container_width=True)
